        ...
        >
          <div
            ...
            style={{
              ...
              background:
                " linear-gradient(to bottom, rgba(25,25,35,0.95) 0%, rgba(10,10,15,1) 100%)",
              borderRadius: cardRadius,
              display: "grid",
              gridArea: "1 / -1",
            }}
          >
            ...
            >
              ...
              {showUserInfo && (
                <div
                  className=" bg-black absolute z-[2] flex items-center justify-between backdrop-blur-[30px] border border-white/10 pointer-events-auto"
                  style={
                    {
                      "--ui-inset": "20px",
                      "--ui-radius-bias": "6px",
                ...
                >
                  ...
                  <button
                    className="border bg-[#0077B5] hover:scale-110 border-white/10 rounded-lg px-4 py-3 text-xs font-semibold text-white cursor-pointer backdrop-blur-[10px] transition-all duration-200 ease-out hover:border-white/40 hover:-translate-y-px"
